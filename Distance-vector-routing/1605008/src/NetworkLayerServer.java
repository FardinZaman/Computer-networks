...
public class NetworkLayerServer {
    ...
    static ArrayList<EndDevice> activeClientList = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        {
            System.out.println(router.getState());
        }
        ...
        while(true) {
            try {
                ...
                activeClientList.add(endDevice);
    ...
    public static synchronized void DVR(int startingRouterId) {
        ...
        */
        ...
        while(convergence)
        {
            ...
            Router r = routerMap.get(startingRouterId);
            int totalNeighbors = r.getNeighborRouterIDs().size();
            ...
            for(int i=0 ; i<totalNeighbors ; i++)
            {
                ...
                int neighborID = r.getNeighborRouterIDs().get(i);

                Router t = routerMap.get(neighborID);
            ...
            for(Map.Entry<Integer , Router> entry : routerMap.entrySet())
            {
                ...
                if (id == startingRouterId)
                    continue;

                r = entry.getValue();
                totalNeighbors = r.getNeighborRouterIDs().size();
